...
function doo_paginationhome($pages = false){
    $range = cs_get_option('pagrange', 2);
    $showitems = ($range * 2)+1;
    global $paged;
    if(empty($paged)) $paged = 1;
    ...
    if(1 != $pages)  {
        ...
        echo "<a class='currentpaginationx' href='https://moviebkk.com/movies/page/1/'>1</a>";
        echo "<a href='https://moviebkk.com/movies/page/2/'>2</a>";
        echo "<a href='https://moviebkk.com/movies/page/3/'>3</a>";
        echo "<a href='https://moviebkk.com/movies/page/4/'>4</a>";
        if ($paged < $pages && $showitems < $pages) echo "<a class='arrow_pag' href='https://moviebkk.com/movies/page/2/'><i id='' class='icon-caret-right'></i></a>";
        if ($paged < $pages-1 &&  $paged+$range-1 < $pages && $showitems < $pages) echo "";
        echo "</div>\n";
	    echo "<div class='resppages'>";
		echo "<a href='https://moviebkk.com/movies/page/2/' class='icon-chevron-right'></a>";
	    echo "</div>";
    }
}
