...
$xxx01 = 'xxx';
    ...
    public function displaynoneads(){
    ...
    public static function viewer($post, $type, $players, $trailer, $size, $views, $ads = false, $image = false){
        $playerx1 = get_field( "player1" );
        //$playerx2 = get_field( "player2" );
        //$playerx3 = get_field( "player3" );
        //$playerx4 = get_field( "player4" );
        ...
        if($players OR $trailer){
            ...
            if($size === 'regular'){
                ...
                if(empty($playerx1)){
                    ...
                    $html .="<div class='iframexx01'>$playerx1</div>";
                }
                $html .="</div>";
            }
            $addlinetitle = 'อัพเดทหนังใหม่ทุกวัน Add เลย !!';
		
            $html .="<a class='btn001' href='https://lin.ee/Q2P9srLz' target='_blank'>
            <img class='imgline' width='25' src='/wp-content/uploads/photoicon/icons8-line-48.png'>
            {$addlinetitle}
            </a>";
    
    
                $html .="<h2>".__d('ลิ้งค์สำรอง')." <span id='playernotice' data-text='{$views}'>{$views}</span></h2>";
