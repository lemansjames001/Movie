...
<div class="contentxxx">
    ...
    <p>ดูหนังออนไลน์ <?php the_tags(); ?> เรื่อง <strong class="movietitle"><?php the_title(); ?></strong><?php the_content(); ?> <p>หนังดีหนังเด่นที่ทุกคนพากันติดตามเป็นจำนวนมาก ซึ่งหนังเรื่องนี้ถือได้ว่าเป็นภาพยนตร์เรื่องดังไปทั่วโลก หากใครพลาดที่จะรับชมภายในโรงภาพยนตร์ ในตอนนี้หากใครอยากจะติดตามรับชม ดูหนัง <?php the_tags(); ?>
