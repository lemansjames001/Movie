...
<header>
	...
	<?php } ?>
	<span class="textseeall"><?php echo $totl; ?> <a href="<?php echo $pmlk; ?>" class="see-all"><?php _d('ดูทั้งหมด'); ?></a></span>
</header>
<div id="movload" class="load_modules"><?php _d('Loading..'); ?></div>
<div <?php echo $eowl; ?>class="items">
	<?php query_posts($query);  while(have_posts()){ the_post(); get_template_part('inc/parts/item');  } doo_paginationhome(); wp_reset_query(); ?>
</div>
