...
class ReadMoreData {
	...
	public static function getAllDataByLimit($offset, $limit = 1) {
		
		global $wpdb;
		
		$results = $wpdb->get_results("SELECT * FROM {$wpdb->prefix}expm_maker ORDER BY ID DESC LIMIT $offset, $limit", ARRAY_A);
